...
verbose_prompt = """You are a marketing analyst tasked with analyzing campaign performance data and generating a narrative report.
...
print(verbose_prompt == prompts[-1])
